// ======================================================================
// \title  IMUTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef IMU_IMUTOPOLOGY_HPP
#define IMU_IMUTOPOLOGY_HPP
// Included for access to IMU::TopologyState and IMU::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <IMU/Top/IMUTopologyDefs.hpp>
#include <Fw/Logger/Logger.hpp>
// Remove unnecessary IMU:: qualifications
using namespace IMU;
namespace IMU {
/**
 ...
 * IMU::TopologyState see: IMUTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type IMU::TopologyState see: IMUTopologyDefs.hpp.
 *
