...
//#include <IMU/Top/IMUPacketsAc.hpp>
...
Svc::Health::PingEntry pingEntries[] = {
    {PingEntries::IMU_blockDrv::WARN, PingEntries::IMU_blockDrv::FATAL, "blockDrv"},
    {PingEntries::IMU_tlmSend::WARN, PingEntries::IMU_tlmSend::FATAL, "chanTlm"},
    {PingEntries::IMU_cmdDisp::WARN, PingEntries::IMU_cmdDisp::FATAL, "cmdDisp"},
    {PingEntries::IMU_cmdSeq::WARN, PingEntries::IMU_cmdSeq::FATAL, "cmdSeq"},
    {PingEntries::IMU_eventLogger::WARN, PingEntries::IMU_eventLogger::FATAL, "eventLogger"},
    {PingEntries::IMU_fileDownlink::WARN, PingEntries::IMU_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::IMU_fileManager::WARN, PingEntries::IMU_fileManager::FATAL, "fileManager"},
    {PingEntries::IMU_fileUplink::WARN, PingEntries::IMU_fileUplink::FATAL, "fileUplink"},
    {PingEntries::IMU_prmDb::WARN, PingEntries::IMU_prmDb::FATAL, "prmDb"},
    {PingEntries::IMU_rateGroup1::WARN, PingEntries::IMU_rateGroup1::FATAL, "rateGroup1"},
    {PingEntries::IMU_rateGroup2::WARN, PingEntries::IMU_rateGroup2::FATAL, "rateGroup2"},
    {PingEntries::IMU_rateGroup3::WARN, PingEntries::IMU_rateGroup3::FATAL, "rateGroup3"},
};
...
void configureTopology(const TopologyState& state) {
    ...
    // Note: Uncomment when using Svc:TlmPacketizer
    // tlmSend.setPacketList(IMUPacketsPkts, IMUPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name IMU
namespace IMU {
