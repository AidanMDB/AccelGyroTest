...
int main(int argc, char* argv[]) {
    ...
    IMU::setupTopology(inputs);
    IMU::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    IMU::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
